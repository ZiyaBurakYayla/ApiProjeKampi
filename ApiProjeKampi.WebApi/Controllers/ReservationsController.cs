...
using ApiProjeKampi.WebApi.Dtos.ReservaitonDtos;
...
namespace ApiProjeKampi.WebApi.Controllers
{
    ...
    public class ReservationsController : ControllerBase
    {
        ...
        public IActionResult AddReservation(CreateReservationDto createReservationDto)
        {
            ...
            return Ok("Reservation ekleme başarılı.");
        }
        ...
        public IActionResult DeleteReservation(int id)
        {
            ...
            _context.SaveChanges();
            return Ok("Reservation silme başarılı.");
        }
        ...
        public IActionResult UpdateReservation(UpdateReservationDto updateReservationDto)
        {
            ...
            _context.SaveChanges();
            return Ok("Reservation güncelleme başarılı.");
        }
