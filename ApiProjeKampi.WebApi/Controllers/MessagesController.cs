...
namespace ApiProjeKampi.WebApi.Controllers
{
    ...
    public class MessagesController : ControllerBase
    {
        ...
        public IActionResult CreateMessage(CreateMessageDto createMessageDto)
        {
            ...
            return Ok("Message ekleme başarılı.");
        }
        [HttpDelete]
        public IActionResult DeleteMessage(int id)
        {
            ...
            _context.SaveChanges();
            return Ok("Message silme başarılı.");
        }
        [HttpPut]
        public IActionResult UpdateMessage(UpdateMessageDto updateMessageDto)
        {
            ...
            _context.SaveChanges();
            return Ok("Message güncelleme başarılı.");
        }

        [HttpGet("MessageListByIsReadFalse")]
        public IActionResult MessageListByIsReadFalse()
        {
            var values = _context.Messages.Where(s => s.IsRead == false).ToList();
            return Ok(_mapper.Map<List<ResultMessageDto>>(values));
        }
    }
}
