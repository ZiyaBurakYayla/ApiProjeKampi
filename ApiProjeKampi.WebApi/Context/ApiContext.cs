...
namespace ApiProjeKampi.WebApi.Context
{
    public class ApiContext : DbContext
    {
        ...
        {
            optionsBuilder.UseSqlServer("Server=ZIYABURAKYAYLA\\SQLEXPRESS;initial catalog=ApiYummyDb;Integrated Security=True;Trusted_Connection=True;TrustServerCertificate=true;");
        }
